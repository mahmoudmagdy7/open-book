  ...
  return (
    <footer className=" text-start text-base">
            ...
            <div className="col-1 px-4">
              ...
              <div>
                <p className="mt-4 leading-relaxed  ">
                  ...
                  الإلكتروني وضعفه في المجالات المعرفية المختلفة، حيث سعت
                  المبادرة إلى سد جزء يسير من هذا النقص عبر الموسوعة الحرة
                  الأهم، موسوعة ويكيبيديا العربية،
                </p>
              </div>
              <div>
      ...
      <div className="border-t">
        <div className="container mx-auto ">
          <div className="max-w-screen-xl  m-auto flex lg:justify-between md:justify-between flex-wrap py-5 px-2 text-center text-gray-500 justify-center ">
